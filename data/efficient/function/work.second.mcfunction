...
execute if entity @e[type=item,distance=..1,nbt={Item:{id:"minecraft:enchanted_book"}}] if entity @e[type=item,distance=..1,nbt={Item:{id:"minecraft:diamond_block"}}] unless score @s efficient.type matches 0 run function efficient:work.third
